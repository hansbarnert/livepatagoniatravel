...
const translations = {
  ...
  es: {
    ...
    'tours.isla_magdalena.desc': 'El Tour Isla Magdalena comprende la visita a un ecosistema único. Isla Magdalena es una isla chilena ubicada en el Estrecho de Magallanes, conocida por ser Monumento Natural de los Pingüinos, podrás interactuar con Pingüinos de Magallanes o también conocidos como Pingüino Patagónico. Podrás admirar y fotografiar especies maravillosas como Cormoranes, Gaviotas Australes y Palomas Antárticas, elefantes marinos y lobos de mar, especies bajo protección a la vida silvestre por lo que la interacción no es permitida, pero el desembarco en Isla Magdalena nos permitirá brindar una experiencia inolvidable con otras especies y los inigualables pingüinos. La duración del tour es de 10 horas si el inicio es en Puerto Natales y 4 horas desde Punta Arenas.',
